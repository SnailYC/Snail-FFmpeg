...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-encoder=pcm*"
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-indevs"
...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-optimizations"
